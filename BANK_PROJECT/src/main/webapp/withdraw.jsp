...
body {
	 text-align:center;
	margin: auto;
	background-image: url('log25.jpg');
  	background-size: 100%;
  	margin:85px;
}
</style>
...
<h1>WITHDRAW FORM</h1>
<form action="WithdrawCode.jsp" method="post" name="regform" onsubmit="return register()">
<center><table>
<tr>
<td>Account No: </td>
<td><input type="text" name="acno" placeholder="Enter account no"></td>
</tr>
<tr>
<td>Name: </td>
